...
fun setKeyListeners(view: View?, operationViewModel: OperationViewModel) {
    when (view?.id) {
        ...
        R.id.button_ln -> operationViewModel.cosOperand()
        R.id.button_sine -> operationViewModel.tanOperand()
        R.id.button_cos -> operationViewModel.sineOperand()
        R.id.button_log_ten -> operationViewModel.logBaseTenOperand()
        R.id.button_tan -> operationViewModel.naturalLogOperand()
